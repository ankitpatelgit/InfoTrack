...
public class CustomReporter extends CustomReporterListener {
	...
	private void startResultSummaryTable(String style) { 
		...
		m_out.println("<tr><td bgcolor='white' colspan='5'> <table border='0' width='100%' bgcolor='#e6f7ff'><tr>"
				...
				+ "<center><img width='150px' src='/logos/doodles/2020/december-holidays-days-2-30-6753651837108830.3-law.gif'/></center>"
	...
	protected void endHtml(PrintWriter out) {
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='5'><center><b><i>Report customized by Ankit Patel </i><b><center></center></b></b></center></td></tr>");
